...
namespace EjemploAdmonTi.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PersonaId,Nombre,Apellido,UserId")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("PersonaId,Nombre,Apellido,UserId")] Persona persona)
        {
