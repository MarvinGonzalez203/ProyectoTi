...
namespace EjemploAdmonTi.Controllers
{
    public class BodegasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdBodega,NombreBodega,Ubicacion,Estado")] Bodega bodega)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdBodega,NombreBodega,Ubicacion,Estado")] Bodega bodega)
        {
