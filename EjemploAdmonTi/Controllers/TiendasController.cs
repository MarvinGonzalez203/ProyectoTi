...
namespace EjemploAdmonTi.Controllers
{
    public class TiendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdTienda,NombreTienda,Direccion,Telefono,Estado")] Tienda tienda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTienda,NombreTienda,Direccion,Telefono,Estado")] Tienda tienda)
        {
