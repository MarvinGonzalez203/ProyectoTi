...
namespace EjemploAdmonTi.Controllers
{
    public class PromocionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPromocion,NombrePromocion,Descripcion,Descuento,FechaInicio,FechaFin,Estado")] Promocion promocion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPromocion,NombrePromocion,Descripcion,Descuento,FechaInicio,FechaFin,Estado")] Promocion promocion)
        {
